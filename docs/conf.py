# -*- coding: utf-8 -*-
#
# napari-scixtracer documentation build configuration file, created by
...
man_pages = [
    (master_doc, 'napari-cookiecutterplugin_name', u'napari-scixtracer Documentation',
     [author], 1)
]
